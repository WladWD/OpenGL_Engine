...
namespace ComputeTileShading
{
	class LightCompute
	{
		...
		void Init(void);
	public:
		LightCompute(LightManager *light_manager, MCamera::Camera *camera, RenderResource::RenderResources<2, 1> *render_resources, const DeferredRendering::GBufferData &gbuffer_data, GLuint EnvMap);
		~LightCompute();
