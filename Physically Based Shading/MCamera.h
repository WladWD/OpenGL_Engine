...
#define TWOPI PI * 2.0f
	...
	public:
		...
		/////////////////////////////////
		mat4 GetViewMatrix();//получить матрицу вида
		mat4 GetProjMatrix();//получить матрицу поэкции
		mat4 GetProjViewMatrix();//получить итоговую матрицу проэцирования
		/////////////////////////////////
		float GetNearPlane();//получить ближнюю плоскость отсечения
		float GetFarPlane();//получить дальнюю плоскость отсечения
		/////////////////////////////////
		vec3 GetPosition();//получить позицию камеры
		/////////////////////////////////
		vec3 GetCamDir();//получить вектор взгляда камеры(вектор k)
		/////////////////////////////////
