...
void DeferredRendering::DrawGBuffer::UpdateMip(void)
{
	for (size_t i = 0; i < GBufferTexturesCount; ++i) 
		glGenerateTextureMipmap(g_buffer_textures[i]);
	glGenerateTextureMipmap(g_buffer_depth);
}
