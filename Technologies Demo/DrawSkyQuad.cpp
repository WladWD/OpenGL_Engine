...
{
	glm::mat4 world;
//	glm::vec3 ncp = -glm::normalize(light_dir);
	...
	//glm::vec3 ncp = -glm::normalize(glm::vec3(translation_matrix[3]));
	//glm::mat4 rotation_matrix = //glm::mat4_cast(glm::quat(ncp.x, glm::vec3(0.0f, sqrt(1.0f - ncp.x * ncp.x), 0.0f)));// *
		//glm::rotate(glm::mat4(1.0f), acos(ncp.y), glm::vec3(0.0f, 0.0f, 1.0f));
		//glm::mat4_cast(glm::quat(ncp.y, glm::vec3(0.0f, 0.0f, sqrt(1.0f - ncp.y * ncp.y))));
